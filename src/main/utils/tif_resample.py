...
def resampling(source_file, target_file, scale=1.0):
    ...
    for index in range(1, total):
        ...
        no_data_value=dataset.GetRasterBand(index).GetNoDataValue()
...
if __name__ == "__main__":
    # 500m
    source_file = r"/Users/whvixd/Documents/individual/MODIS/dataset/china_referenceImagine.tif"
    # 5km
    target_file = r"/Users/whvixd/Documents/individual/MODIS/dataset/china_5km_referenceImagine.tif"
